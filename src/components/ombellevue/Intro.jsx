      ...
      <SnapWrapper
        ...
        <div className="flex flex-col items-center justify-center h-full px-8 gap-10  w-full">
          ...
          <p className="max-w-3xl text-center font-bold">
            ...
            som Arne Jacobsen tegnede til området omkring Bellevue Strand i
            1930'erne, og som har givet området tilnavnet "Arne Jacobsens Hvide
            By" Alt sammen i tråd med periodens idealer om sundhed, renlighed og
            kropslig udfoldelse.
          </p>
        </div>
      </SnapWrapper>
