      ...
      <div className="flex flex-col md:flex-row gap-20">
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <p>
              Sikre dig pladser før offentligheden, især til særligt
              efterspurgte forestillinger.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p>
              Oplev rundvisninger, sæsonpræsentationer og talks kun for
              medlemmer.
            </p>
          </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <p>
              Modtag et medlemsnyhedsbrev med historier, interviews og glimt fra
              prøvearbejdet
            </p>
          </div>
          <div className="flex flex-col gap-2">
            ...
            <p>
              Bliv en del af en engageret gruppe, der bakker op om Bellevue
              Teatrets virke.
            </p>
          </div>
        </div>
