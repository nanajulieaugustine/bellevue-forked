    ...
    <section className="flex flex-col gap-20" id="bookbilletter">
      ...
      <div className="flex justify-between gap-20">
        ...
        >
          ...
          <p className="max-w-150">
            ...
            Under eventet er der en blå bjælke, hvorpå der står: ”Find billetten her”.
            Klik på denne. Herefter bliver du sendt videre til Ticketmaster.
          </p>
        </motion.div>
      ...
      <div className="flex justify-between gap-20">
        ...
        >
          ...
          <p className="max-w-150">
            Du bliver nu bedt om at logge ind. Hvis du allerede har en profil hos
            Ticketmaster, skal du bruge den. Ellers opretter du en ny.
          </p>
        </motion.div>
