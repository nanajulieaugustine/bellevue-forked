...
const VennerQuestion = () => (
    <div>
        <div className="grid grid-cols-2">
            ...
            <div>
            <p>Spørgsmål til indmeldelse, udmeldelse, 
            kontingent og lignende kan sendes til venner@bellevueteatret.dk.</p>
            <p className="pt-5">Andre spørgsmål kan rettes til Bellevue Teatrets Venner den 4., 6.,</p>
